...
const ja: Dict = {
  ...
  window_empty2: '漂流瓶タブから、今日の1枚を流してみましょう。',
  fab_aria: '撮影する',
  ...
  bottle_shoot: '撮影して流す',
  bottle_shootPrompt: 'まだ今日の瓶を流していません。',
  bottle_note:
...
const en: Dict = {
  ...
  window_empty2: 'Go to the Bottle tab to set today’s photo adrift.',
  ...
  bottle_shootPrompt: "You haven't set a bottle adrift today yet.",
  bottle_note:
...
const zh: Dict = {
  ...
  window_empty2: '请前往漂流瓶标签，放出今天的一张照片。',
  fab_aria: '拍照',
...
const ko: Dict = {
  ...
  window_empty2: '유리병 탭에서 오늘의 한 장을 띄워 보세요.',
  fab_aria: '촬영하기',
  ...
  bottle_shootPrompt: '오늘은 아직 유리병을 띄우지 않았어요.',
  bottle_note:
...
const es: Dict = {
  ...
  window_empty2: 'Ve a la pestaña Botella para lanzar la foto de hoy.',
  ...
  bottle_shootPrompt: 'Aún no has lanzado una botella hoy.',
  bottle_note:
...
const fr: Dict = {
  ...
  window_empty2: 'Va dans l’onglet Bouteille pour lancer la photo du jour.',
  ...
  bottle_shootPrompt: 'Tu n’as pas encore lancé de bouteille aujourd’hui.',
  bottle_note:
...
const pt: Dict = {
  ...
  window_empty2: 'Vá à aba Garrafa para lançar a foto de hoje.',
  ...
  bottle_shootPrompt: 'Você ainda não lançou uma garrafa hoje.',
  bottle_note:
...
const de: Dict = {
  ...
  window_empty2: 'Geh zum Tab Flasche, um das heutige Foto auszusenden.',
  ...
  bottle_shootPrompt: 'Du hast heute noch keine Flasche ausgesandt.',
  bottle_note:
